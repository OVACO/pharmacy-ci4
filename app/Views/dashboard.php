                        ...
                        <div class="card-body p-0">
                            ...
                            <h3>
                                ...
                                <form name="form" method="post">
                                    วันที่ : <input type="date" name="startdate" value="<?php echo $startdate; ?>" />
                                    ถึงวันที่ : <input type="date" name="enddate" value="<?php echo $enddate; ?>" />
                                ...
                                <div class="text-center">
                                    <table class="table table-hover " id="dashboard-list00">
                                        ...
                                        <tbody>
                                            <?php foreach($pharmacy as $row): if($row['status_id'] == 2){ 
                                                ?>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                         ...
                                                         echo 'วันที่นัดหมาย : '.DateThai($row['date_app']).'<br>';
